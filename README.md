...
## Local Development
**DISCLAIMER**: This scraper retrieves data from a public, university site whose primary goal is to serve students. Please obtain permission before scraping data and employ best practices.
